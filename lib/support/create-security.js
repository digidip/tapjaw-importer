...
const apply_custom_http_header_wrapper_1 = (0, tslib_1.__importDefault)(require("../authenticators/wrappers/apply-custom-http-header-wrapper"));
...
const non_bearer_authorization_authenticator_1 = (0, tslib_1.__importDefault)(require("../authenticators/non-bearer-authorization-authenticator"));
const custom_header_authenticator_1 = (0, tslib_1.__importDefault)(require("../authenticators/custom-header-authenticator"));
...
const apply_oauth_refresh_http_header_wrapper_1 = (0, tslib_1.__importDefault)(require("../authenticators/wrappers/apply-oauth-refresh-http-header-wrapper"));
const oauth_refresh_authenticator_1 = (0, tslib_1.__importDefault)(require("../authenticators/oauth-refresh-authenticator"));
const prefetch_token_authorization_header_authenticator_1 = (0, tslib_1.__importDefault)(require("../authenticators/prefetch-token-authorization-header-authenticator"));
