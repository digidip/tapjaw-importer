...
const tapjaw_config_1 = tslib_1.__importDefault(require("../configs/tapjaw-config"));
const utc_date_1 = tslib_1.__importDefault(require("../date/utc-date"));
/**
...
class TapjawMessage {
     ...
     */
    getSha256Secret() {
        return (0, tapjaw_config_1.default)('MESSAGE_SHA256_SECRET');
    }
}
