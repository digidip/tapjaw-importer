...
const oauth_authenticator_1 = (0, tslib_1.__importDefault)(require("../../oauth-authenticator"));
...
describe('Test ApplyOauthAuthorizationHttpHeaderWrapper', () => {
    test('Make sure the "Authorization: Basic XXX" header is provided from OAuth authenticator', async () => {
        ...
        const oauth = new oauth_authenticator_1.default('aclient', 'asecret', '127.0.0.1', '/token', {});
        ...
        const instance = new apply_oauth_authorization_http_header_wrapper_1.default(oauth);
