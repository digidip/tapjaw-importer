        ...
        return new Promise(async (resolve, reject) => {
            ...
            if (this.authenticator.isAuthenticated()) {
                ...
                if (!this.authenticationData ||
                    ...
                    return reject(new tapjaw_authenticator_1.TapjawAuthenticatorError(`No "access_token" property provided from authenticator: ${this
            ...
            if (!this.authenticationData) {
                return reject(new tapjaw_authenticator_1.TapjawAuthenticatorError(`No OAuth data recieved from authenticator: ${this
                    .authenticator.constructor.name || "Unknown"}`));
            }
