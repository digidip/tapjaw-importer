...
const tapjaw_http_connector_1 = tslib_1.__importDefault(require("./tapjaw-http-connector"));
const connector_register_1 = tslib_1.__importDefault(require("../reflection/connector-register"));
/**
