...
const stdout_iterator_1 = require("../iterators/stdout-iterator");
class TapjawCommand extends command_1.Command {
    ...
    async run() {
        ...
        await this.iterator.run(this.getAdapterCallback(args, flags), flags.limit && Number.isInteger(flags.limit) ? flags.limit : undefined);
    }
}
...
TapjawCommand.defaultFlags = {
    ...
    limit: command_1.flags.integer({ char: 'l', description: 'Limit the number of outputted JSON messages' }),
};
