...
const console_logger_1 = tslib_1.__importDefault(require("../support/console-logger"));
const json_message_parser_1 = tslib_1.__importDefault(require("../parsers/json-message-parser"));
const typeguards_1 = require("../typeguards");
const command_register_1 = tslib_1.__importDefault(require("../reflection/command-register"));
            ...
            this.stdin
                ...
                if ((0, typeguards_1.isTapjawMessage)(message)) {
                    this.onMessageFilter(message, args, flags)
                        ...
                        .catch(instance.getLogger().error);
                }
            }))
                .on('end', resolve)
                .on('error', reject);
