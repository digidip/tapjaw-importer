        ...
        return new Promise(async (resolve, reject) => {
            ...
            if (this.authenticator.isAuthenticated()) {
                ...
                if (!this.authenticationData || !this.authenticationData.access_token) {
                    ...
                    return reject(new TapjawAuthenticatorError(`No "access_token" property provided from authenticator: ${this.authenticator.constructor.name || 'Unknown'}`));
                }
            ...
            if (!this.authenticationData) {
                return reject(new TapjawAuthenticatorError(`No OAuth data recieved from authenticator: ${this.authenticator.constructor.name || 'Unknown'}`));
            }
